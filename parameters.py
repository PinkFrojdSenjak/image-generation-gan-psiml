...
def get_parameters():
    ...
    parser.add_argument('--model', type=str, default='psagan', choices=['psagan', 'pgan'])
    ...
    parser.add_argument('--version', type=str, default='psagan_1')
    ...
    parser.add_argument('--sigma-update-delta', type=int, default=0.005)
